...
watch(() => props.tagFilter, (val) => { localTag.value = val })
</script>
  ...
  <div class="flex flex-col sm:flex-row gap-3 mb-5">
    ...
    <div class="relative flex-1">
      ...
      <input
        ...
        class="w-full rounded-xl border border-black/10 bg-white pl-10 pr-4 py-2.5 text-sm text-ink placeholder-gray-400 focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent transition-colors"
        @input="onSearchInput"
      />
      <button
        v-if="localSearch"
        ...
        @click="localSearch = ''; emit('update:searchQuery', '')"
      >
