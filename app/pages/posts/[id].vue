  ...
  <div class="min-h-screen bg-paper">
    <div class="mx-auto max-w-2xl px-4 py-10">
      ...
      <article v-else class="rounded-xl bg-white p-6">
        ...
        <p
          class="mb-6 whitespace-pre-line text-sm leading-relaxed text-gray-600"
        >
          {{ post.body }}
        </p>
